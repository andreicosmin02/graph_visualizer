...
class GraphService:
    ...
    def add_edge(self, source_id: str, target_id: str, flux: float = 1.0, capacity: float | None = None) -> Edge:
        """Add edge between nodes."""
        return self.graph.add_edge(source_id, target_id, flux, capacity)
    ...
    def get_node_at_position(self, x: float, y: float, radius: float = 30.0) -> Node | None:
